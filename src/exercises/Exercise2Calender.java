...
public class Exercise2Calender {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		while(!(driver.findElement(By.cssSelector(".ui-datepicker-month")).getText() + " " + driver.findElement(By.cssSelector(".ui-datepicker-year")).getText()).contains(travelDate)) {
